...
prefixStatus = true;
hit_today = [];
zeksApikey = 'Rq7TKca5YDaBb0qCNvvgoAft6EL'; //replace using your apikey so that the limit doesn't run out quickly 
...
budy = 
    ...
    const grupinv = (teks) => {
        	grup = mess.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/FpE1TXXUzuk0TASzYwX8ZM', "groupName": `${NamaBot}`, "footerText": "*_© SKETCHY-BOT_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
`;
      ...
      case "antilink":
        ...
        if (args[0] == "on") {
          ...
          reply("Successfully turned off antilink!");
        } else if (!q) {
      ...
      case "delete":
        ...
        case "profile":
					...
					break;
      case "listonline": //values found by Sketchy
      ...
      case "sider": //values found by Sketchy
...
`.trim();
      ...
      case "kick":
        ...
        if (
          ...
          return reply("TOKAAAAAA!!!😂😂😂Shenzi typen!");
      ...
      case "promote":
        ...
        if (
          ...
          return reply("You are Now admin");
        mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
